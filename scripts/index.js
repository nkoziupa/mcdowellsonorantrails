...
var markerList = ["AG1", "AG1X", "AG2X", "AG3", "AG5", "AG7", "AG9", "AG11", "AG13", "AG14", "AG15", "AG17", "AG19", "AGWX", "AH1", "AHX", "AMPX", "BA1", "BAX", "BH1", "BH1X", "BH2", "BH2X", "BH3", "BH3X", "BH4", "BH4X", "BHX", "BL1X", "BL2", "BMSX", "BP1X", "BP2X", "BP3X", "BP4X", "BR3", "BR5", "BR6", "BR9", "BROX", "BRTX", "BRX", "BS1", "BSTX", "BT1", "BT2", "BT4", "BT6", "BTTX", "CC1", "CL1", "CL2", "CL3", "CL5", "CL6", "CM1", "CM2", "CM4", "CM5", "CM6", "CM7", "CM8", "CN3", "CN5", "CP1", "CP3", "CRX", "CSX", "CW3", "CW5", "CW7", "CW11", "DS1", "DS3", "DS5", "DS7", "DS9", "DS11", "DV1", "DV2", "DV3", "DV5", "DV7", "DV8", "DV9", "DV11", "DV13", "DV17", "DV19", "DV21", "DV23", "DX1", "DX1X", "DX2", "DX3", "DX5", "DXX", "FIAX", "FIBX", "FICX", "FIDX", "FIEX", "FT2X", "FT3X", "FT4X", "FTAX", "FTX", "GE1X", "GE2X", "GE3X", "GE4X", "GM1", "GM2", "GM3", "GM4", "GM5", "GM6", "GM7", "GM8X", "GM9", "GM9X", "GM10", "GMHX", "GMTX", "GN1", "GN2", "GNX", "GT1X", "GT3X", "GT4X", "HD1", "HD3", "HD5", "HT1", "HT3", "HV6", "HV9", "HV51", "HV55", "HV56", "HV57", "HV58", "HV65", "HV73", "HV75", "HW1", "HW1X", "HW2X", "HW3X", "HW4", "HW10", "HW12", "HW16", "HW20", "HW26", "HW28", "HW30", "HW31", "HW33", "HW35", "HW37", "HW40", "HW41", "HW42", "HW44", "HW46", "JR1X", "JR2X", "JRCX", "JRTX", "LG1", "LG2", "LG3", "LG4", "LG5", "LG7", "LG9", "LG13", "LG15", "LG17", "LG19", "LG21", "LG24", "LG25", "LG28", "LG29", "LGAX", "MG1", "MGX", "MO1", "MP1", "MP3", "MPX", "MT1", "MTX", "MV1", "MV2", "MV3", "MV4", "MVX", "ND1", "ND1X", "ND2X", "ND3X", "ND4X", "ND5X", "ND6X", "ND7X", "ND8X", "ND9X", "ND5", "OC1", "OC3", "OC7", "OHTX", "OP1", "OP3", "OP5", "OP7", "OP9", "OP11", "PD1X", "PD2X", "PD3X", "PD4X", "PD5X", "PD6X", "PD7X", "PD8X", "PDHX", "PDTX", "PDXX", "PR1X", "PR3X", "PR4X", "PR5X", "RC1", "RC1X", "RC4", "RC5", "RG1", "RG5", "RG7", "RG9", "RG11", "RGX", "RH1", "RH1X", "RH2", "RH3", "RH5", "RH7", "RH9", "RH11", "RH13", "RH15", "RH17", "RS2", "RS3", "RS4", "SB1", "SB3", "SBX", "SC1", "SC7", "SC17", "SC27", "SD1", "SD1X", "SD2X", "SD3X", "SD4X", "SD5X", "SD6X", "SD7X", "SD8X", "SD5", "SE3", "SP1", "SP3", "SP5", "SP7", "SP9", "S
65", "XM66", "XM67", "XM68", "XM69", "XM70", "XM71", "XM72", "XM73", "XM74", "XM75", "XM76", "XM77", "XM78", "XM79", "XM80", "XM81", "XF01", "XF02", "XF03", "XF04", "XF06", "XF07", "XF08", "XF11", "XF12", "XF13", "XF14", "XF15", "XF16", "XF17", "XF18", "XF19", "XF23", "XF24", "XF25", "XF30", "XF31", "XF34", "XF35", "XF37", "XF38", "XF39", "XF40", "XF41", "XF42", "XFWX", "XMCS", "XMFS", "XMTS", "XFAX", "XFGX"];
...
var markerAG1X = L.circle([33.746662, -111.886886], new CreateMarker("AG1X", "Intersection", 2336, ["AG2X", "PDTX"])).addTo(map).on("click", onMapClick);
var markerAG2X = L.circle([33.747153, -111.886778], new CreateMarker("AG2X", "Intersection", 2339, ["PD4X", "AG19", "HW2X", "AG1X"])).addTo(map).on("click", onMapClick);
...
var markerAG14 = L.circle([33.762595, -111.883992], new CreateMarker("AG14", "AG14", 2397, ["AG15", "AG13", "RH5"])).addTo(map).on("click", onMapClick);
...
var markerAG15 = L.circle([33.760717, -111.888380], new CreateMarker("AG15", "AG15", 2379, ["STR3", "STR5", "AG14", "AG17"])).addTo(map).on("click", onMapClick);
var markerAG17 = L.circle([33.75937, -111.889014], new CreateMarker("AG17", "AG17", 2361, ["STR3", "AG15", "RH3"])).addTo(map).on("click", onMapClick);
var markerAG19 = L.circle([33.752331, -111.885988], new CreateMarker("AG19", "AG19", 2362, ["RH1", "RH3", "HW46", "AG2X"])).addTo(map).on("click", onMapClick);
...
var markerCSX = L.circle([33.751735, -111.876644], new CreateMarker("CSX", "Scenic Point", 2435, ["SW2X", "SW1", "PR4X"])).addTo(map).on("click", onMapClick);
...
var markerHV73 = L.circle([33.750989, -111.882196], new CreateMarker("HV73", "HV73", 2389, ["HW46", "HW3X", "RC5", "LG29", "PR5X"])).addTo(map).on("click", onMapClick);
var markerHV75 = L.circle([33.745661, -111.885934], new CreateMarker("HV75", "HV75", 2339, ["PDXX", "PD5X", "PR5X", "LG29"])).addTo(map).on("click", onMapClick);
var markerHW1 = L.circle([33.806739, -111.787193], new CreateMarker("HW1", "HW1", 2687, ["BA1", "HW4", "MO1"])).addTo(map).on("click", onMapClick);
var markerHW1X = L.circle([33.746704, -111.886795], new CreateMarker("HW1X", "Intersection", 2337, ["PDTX", "HW2X"])).addTo(map).on("click", onMapClick);
var markerHW2X = L.circle([33.747129, -111.886591], new CreateMarker("HW2X", "Intersection", 2341, ["AG2X", "HW46", "PD5X", "HW1X"])).addTo(map).on("click", onMapClick);
var markerHW3X = L.circle([33.752323, -111.882304], new CreateMarker("HW3X", "Intersection", 2393, ["HW46", "HW44", "HV73"])).addTo(map).on("click", onMapClick);
...
var markerHW44 = L.circle([33.758994, -111.880939], new CreateMarker("HW44", "HW44", 2415, ["RH5", "HW42", "RC5", "HW3X"])).addTo(map).on("click", onMapClick);
var markerHW46 = L.circle([33.751752, -111.88339], new CreateMarker("HW46", "HW46", 2381, ["AG19", "HW3X", "HV73", "HW2X"])).addTo(map).on("click", onMapClick);
...
var markerPR4X = L.circle([33.751092, -111.876344], new CreateMarker("PR4X", "Intersection", 2427, ["CSX", "RC1", "VD7"])).addTo(map).on("click", onMapClick);
var markerPR5X = L.circle([33.746819, -111.885358], new CreateMarker("PR5X", "Intersection", 2344, ["PD5X", "HV73", "HV75"])).addTo(map).on("click", onMapClick);
...
var markerPD1X = L.circle([33.746417, -111.887465], new CreateMarker("PD1X", "Access Point", 2330, ["PD2X"])).addTo(map).on("click", onMapClick);
var markerPD2X = L.circle([33.746511, -111.887387], new CreateMarker("PD2X", "Intersection", 2331, ["PD1X", "PD3X", "PDTX"])).addTo(map).on("click", onMapClick);
var markerPD3X = L.circle([33.746649, -111.887495], new CreateMarker("PD3X", "Intersection", 2330, ["PDHX", "PD4X", "PD2X"])).addTo(map).on("click", onMapClick);
var markerPD4X = L.circle([33.747216, -111.887264], new CreateMarker("PD4X", "Intersection", 2337, ["PD3X", "RH1X", "AG2X"])).addTo(map).on("click", onMapClick);
var markerPD5X = L.circle([33.746698, -111.886284], new CreateMarker("PD5X", "Intersection", 2340, ["PD6X", "HW2X", "PR5X", "HV75", "PD7X"])).addTo(map).on("click", onMapClick);
var markerPD6X = L.circle([33.746572, -111.886613], new CreateMarker("PD6X", "Intersection", 2338, ["PDTX", "PD5X"])).addTo(map).on("click", onMapClick);
var markerPD7X = L.circle([33.746302, -111.886432], new CreateMarker("PD7X", "Intersection", 2334, ["PDTX", "PD5X", "PD8X"])).addTo(map).on("click", onMapClick);
var markerPD8X = L.circle([33.745985, -111.88669], new CreateMarker("PD8X", "Access Point", 2331, ["PD7X"])).addTo(map).on("click", onMapClick);
var markerPDHX = L.circle([33.74683, -111.888.122], new CreateMarker("PDHX", "Access Point", 2330, ["RH1X", "PD3X"])).addTo(map).on("click", onMapClick);
...
var markerRH1 = L.circle([33.751397, -111.887618], new CreateMarker("RH1", "RH1", 2347, ["VD3", "RH2", "AG19", "RH1X"])).addTo(map).on("click", onMapClick);
var markerRH1X = L.circle([33.747648, -111.887744], new CreateMarker("RH1X", "Intersection", 2336, ["PDHX", "VD3", "RH1", "PD4X"])).addTo(map).on("click", onMapClick);
var markerRH2 = L.circle([33.75570076, -111.8909804], new CreateMarker("RH2", "RH2", 2325, ["RH3", "RH1"])).addTo(map).on("click", onMapClick);
var markerRH3 = L.circle([33.757299, -111.888895], new CreateMarker("RH3", "RH3", 2340, ["RH2", "AG17", "RH5", "AG19"])).addTo(map).on("click", onMapClick);
...
var markerRH7 = L.circle([33.768204, -111.877372], new CreateMarker("RH7", "RH7", 2447, ["AG11", "RH9", "HW40", "RH5"])).addTo(map).on("click", onMapClick);
...
var markerPDTX = L.circle([33.746397, -111.886909], new CreateMarkerTrailhead("PDTX", "Trailhead", 2335, ["PD2X", "AG1X", "HW1X", "PD6X", "PD7X"])).addTo(map).on("click", onMapClick);
...
var markerXM68 = L.circle([33.640088, -111.786312], new CreateMarker("XM68", "ST30 / LS11", 2502, ["XF16", "XM65", "XF15"])).addTo(map).on("click", onMapClick);
...
var markerXF08 = L.circle([33.623125, -111.778754], new CreateMarker("XF08", "AK1", 2666, ["AK4", "XF11", "XF25"])).addTo(map).on("click", onMapClick);
var markerXF12 = L.circle([33.625178, -111.78019], new CreateMarker("XF12", "Scenic Point", 3036, ["XF11"])).addTo(map).on("click", onMapClick);
var markerXF11 = L.circle([33.625412, -111.780844], new CreateMarker("XF11", "WL15", 3037, ["XF08", "XF13", "XF12"])).addTo(map).on("click", onMapClick);
var markerXF19 = L.circle([33.629652, -111.778399], new CreateMarker("XF19", "ST1 / LS1", 2522, ["XF13", "XF18", "XF34"])).addTo(map).on("click", onMapClick);
var markerXF13 = L.circle([33.628826, -111.778312], new CreateMarker("XF13", "WL25", 2540, ["XF11", "XF19", "XF14"])).addTo(map).on("click", onMapClick);
var markerXF14 = L.circle([33.625833, -111.774384], new CreateMarker("XF14", "PT9", 2519, ["XF06", "XF13"])).addTo(map).on("click", onMapClick);
var markerXF15 = L.circle([33.637442, -111.785731], new CreateMarker("XF15", "LS8", 2614, ["XF16", "XM68", "XF30"])).addTo(map).on("click", onMapClick);
var markerXF16 = L.circle([33.636392, -111.787500], new CreateMarker("XF16", "ST23", 2734, ["XM68", "XF15", "XF31"])).addTo(map).on("click", onMapClick);
var markerXF30 = L.circle([33.635294, -111.781874], new CreateMarker("XF30", "Intersection", 2517, ["XF17", "XF15"])).addTo(map).on("click", onMapClick);
var markerXF17 = L.circle([33.63456, -111.782076], new CreateMarker("XF17", "LS5", 2474, ["XF18", "XF30", "XF34"])).addTo(map).on("click", onMapClick);
var markerXF18 = L.circle([33.634104, -111.782477], new CreateMarker("XF18", "Intersection", 2513, ["XF19", "XF31", "XF17"])).addTo(map).on("click", onMapClick);
var markerXF25 = L.circle([33.622901, -111.778486], new CreateMarker("XF25", "WL6", 2655, ["XF24", "XF08", "XF23"])).addTo(map).on("click", onMapClick);
var markerXF23 = L.circle([33.622696, -111.778185], new CreateMarker("XF23", "WL5", 2645, ["XF24", "XF25", "XF07"])).addTo(map).on("click", onMapClick);
var markerXF07 = L.circle([33.622526, -111.777864], new CreateMarker("XF07", "Intersection", 2628, ["XF02", "XF23", "XF06"])).addTo(map).on("click", onMapClick);
var markerXF06 = L.circle([33.622515, -111.777168], new CreateMarker("XF06", "WL1", 2556, ["XF02", "XF07", "XF14"])).addTo(map).on("click", onMapClick);
...
var markerXF42 = L.circle([33.610180, -111.759993], new CreateMarker("XF42", "Scenic Point", 2493, ["XF41"])).addTo(map).on("click", onMapClick);
var markerXFWX = L.circle([33.621305, -111.774858], new CreateMarker("XFWX", "Scenic Point", 2499, ["XF01", "XF03"])).addTo(map).on("click", onMapClick);
...
$("#infocontainer-0-button").on("click", function() {
  switch (trailheadCarouselIndex) {
    ...
    case 5:
      ...
      map.flyTo([33.746397, -111.886909], 17, {animate: true, duration: 0.1});
    break;
