...
L.tileLayer('https://api.mapbox.com/styles/v1/nkoziupa/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    attribution: 'Additional attributions and credits',
    minZoom: 10,
    maxZoom: 17,
...
var markerML1 = L.circle([33.694407, -111.801052], new CreateMarker("ML1", "ML1", 2776, ["TH3X", "TTTX", "ML3"])).addTo(map).on("click", onMapClick);
...
var markerTTTX = L.circle([33.694461, -111.801725], new CreateMarkerTrailhead("TTTX", "Trailhead", 2813, ["TT1X", "ML1", "TT1"])).addTo(map).on("click", onMapClick);
...
var markerBH3X = L.circle([33.744894, -111.79403], new CreateMarker("BH3X", "Intersection", 2539, ["BH2X", "BH4X"])).addTo(map).on("click", onMapClick);
var markerBH4 = L.circle([33.752476, -111.799572], new CreateMarker("BH4", "BH4", 2596, ["DX2", "BH1", "BH1X"])).addTo(map).on("click", onMapClick);
var markerBH4X = L.circle([33.744092, -111.792916], new CreateMarker("BH4X", "Intersection", 2531, ["BH3X", "BH3", "FT4X"])).addTo(map).on("click", onMapClick);
var markerBHX = L.circle([33.741724, -111.787050], new CreateMarker("BHX", "Stepover Gate", 2487, ["BH3"])).addTo(map).on("click", onMapClick);
...
var markerCL5 = L.circle([33.785939, -111.843553], new CreateMarker("CL5", "CL5", 2747, ["CL6", "HW26", "CL3"])).addTo(map).on("click", onMapClick);
...
var markerDX1X = L.circle([33.755844, -111.812830], new CreateMarker("DX1X", "Intersection", 2664, ["DX1", "WB3X", "WB4"])).addTo(map).on("click", onMapClick);
...
var markerDXX = L.circle([33.755934, -111.786980], new CreateMarker("DXX", "Stepover Gate", 2526, ["DX5"])).addTo(map).on("click", onMapClick);
var markerFT3X = L.circle([33.744772, -111.794621], new CreateMarker("FT3X", "Intersection", 2539, ["FT2X", "FT4X"])).addTo(map).on("click", onMapClick);
var markerFT2X = L.circle([33.745507, -111.795065], new CreateMarker("FT2X", "Intersection", 2544, ["WB8", "FT3X"])).addTo(map).on("click", onMapClick);
...
var markerFT4X = L.circle([33.743777, -111.79339], new CreateMarker("FT4X", "Intersection", 2529, ["FT3X", "BH4X", "GNX"])).addTo(map).on("click", onMapClick);
...
var markerLG1 = L.circle([33.758820, -111.841372], new CreateMarker("LG1", "LG1", 2731, ["BP2X", "LG7", "LG2"])).addTo(map).on("click", onMapClick);
...
var markerPR2X = L.circle([33.749401, -111.879056], new CreateMarker("PR2X", "Intersection", 2399, ["LG29", "RC1", "PDTX"])).addTo(map).on("click", onMapClick);
var markerPR3X = L.circle([33.757912, -111.864542], new CreateMarker("PR3X", "Intersection", 2540, ["LG13", "LG19", "RC1"])).addTo(map).on("click", onMapClick);
var markerLG19 = L.circle([33.758179, -111.864767], new CreateMarker("LG19", "LG19", 2590, ["LG17", "LG21", "PR3X"])).addTo(map).on("click", onMapClick);
...
var markerSV1X = L.circle([33.759443, -111.844465], new CreateMarker("SV1X", "Scenic Point", 2769, ["SVTX"])).addTo(map).on("click", onMapClick);
...
var markerND1X = L.circle([33.798184, -111.823695], new CreateMarker("ND1X", "Intersection", 2929, ["ND3X", "ND1", "ND2X"])).addTo(map).on("click", onMapClick);
var markerND2X = L.circle([33.797694, -111.823775], new CreateMarker("ND2X", "Intersection", 2937, ["ND3X", "ND1X", "ND1"])).addTo(map).on("click", onMapClick);
var markerND3X = L.circle([33.797998, -111.824342], new CreateMarker("ND3X", "Intersection", 2919, ["ND5", "ND1X", "ND2X"])).addTo(map).on("click", onMapClick);
var markerND4X = L.circle([33.797159, -111.82492], new CreateMarker("ND4X", "Intersection", 2919, ["ND6X", "ND5X", "ND5"])).addTo(map).on("click", onMapClick);
var markerND5X = L.circle([33.797586, -111.825188], new CreateMarker("ND5X", "Loop Point", 2915, ["ND6X", "ND4X"])).addTo(map).on("click", onMapClick);
var markerND6X = L.circle([33.79729, -111.825399], new CreateMarker("ND6X", "Loop Point", 2916, ["ND5X", "ND4X"])).addTo(map).on("click", onMapClick);
var markerND7X = L.circle([33.796156, -111.826114], new CreateMarker("ND7X", "Intersection", 2890, ["ND5", "ND8X", "ND9X"])).addTo(map).on("click", onMapClick);
var markerND8X = L.circle([33.795869, -111.825835], new CreateMarker("ND8X", "Loop Point", 2893, ["ND7X", "ND9X"])).addTo(map).on("click", onMapClick);
var markerND9X = L.circle([33.79588, -111.82634], new CreateMarker("ND9X", "Intersection", 2894, ["ND7X", "ND8X", "SD1"])).addTo(map).on("click", onMapClick);
...
var markerSD1X = L.circle([33.795109, -111.824398], new CreateMarker("SD1X", "Intersection", 2912, ["SD1", "SD2X", "SD3X"])).addTo(map).on("click", onMapClick);
var markerSD2X = L.circle([33.794578, -111.824069], new CreateMarker("SD2X", "Loop Point", 2928, ["SD1X", "SD3X"])).addTo(map).on("click", onMapClick);
var markerSD3X = L.circle([33.794508, -111.823529], new CreateMarker("SD3X", "Intersection", 2929, ["SD1X", "SD2X", "SD4X"])).addTo(map).on("click", onMapClick);
var markerSD4X = L.circle([33.79361, -111.82133], new CreateMarker("SD4X", "Intersection", 2954, ["SD3X", "SD5X", "SD6X"])).addTo(map).on("click", onMapClick);
var markerSD5X = L.circle([33.79306, -111.821198], new CreateMarker("SD5X", "Loop Point", 2965, ["SD4X", "SD6X"])).addTo(map).on("click", onMapClick);
var markerSD6X = L.circle([33.79281, -111.821968], new CreateMarker("SD6X", "Intersection", 2964, ["SD4X", "SD5X", "SD5"])).addTo(map).on("click", onMapClick);
var markerSD7X = L.circle([33.792481, -111.824053], new CreateMarker("SD7X", "Loop Point", 2937, ["SD5", "SD8X"])).addTo(map).on("click", onMapClick);
var markerSD8X = L.circle([33.791578, -111.823085], new CreateMarker("SD8X", "Intersection", 2969, ["SD7X", "SD5", "TD2"])).addTo(map).on("click", onMapClick);
...
var markerBP1X = L.circle([33.762016, -111.842172], new CreateMarker("BP1X", "Intersection", 2721, ["UR1", "JRCX", "BRTX"])).addTo(map).on("click", onMapClick);
...
var markerWB8X = L.circle([33.746824, -111.796031], new CreateMarker("WB8X", "Intersection", 2555, ["WB4", "BH1X", "WB8"])).addTo(map).on("click", onMapClick);
...
var markerWB8 = L.circle([33.746556, -111.795776], new CreateMarker("WB8", "WB8", 2548, ["WB8X", "FTX", "FTAX", "FT2X"])).addTo(map).on("click", onMapClick);
...
var markerBRTX = L.circle([33.761545, -111.842328], new CreateMarkerTrailhead("BRTX", "Trailhead", 2710, ["BP1X", "JRCX", "BSTX", "BP4X", "SVBX"])).addTo(map).on("click", onMapClick);
var markerFTX = L.circle([33.746574, -111.795351], new CreateMarkerTrailhead("FTX", "Trailhead", 2540, ["BH1X", "FTAX", "WB8"])).addTo(map).on("click", onMapClick);
var markerGMTX = L.circle([33.77047, -111.789601], new CreateMarkerTrailhead("GMTX", "Trailhead", 2570, ["GMHX", "GT3X", "TP1X"])).addTo(map).on("click", onMapClick);
var markerPDTX = L.circle([33.743416, -111.887740], new CreateMarkerTrailhead("PDTX", "Trailhead", 2310, ["HV75", "PR2X"])).addTo(map).on("click", onMapClick);
...
var markerDP3 = L.circle([33.668660, -111.839496], new CreateMarker("DP3", "DP3", 1833, ["DP5", "WP3"])).addTo(map).on("click", onMapClick);
...
var markerHHVX = L.circle([33.688326, -111.804996], new CreateMarker("HHVX", "Scenic Point", 3085, ["TTV1"])).addTo(map).on("click", onMapClick);
...
var markerLDOX = L.circle([33.608829, -111.808784], new CreateMarker("LDOX", "Scenic Point", 2000, ["RT5"])).addTo(map).on("click", onMapClick);
...
var markerPFOX = L.circle([33.681021, -111.804161], new CreateMarker("PFOX", "Scenic Point", 3664, ["TTV4"])).addTo(map).on("click", onMapClick);
...
var markerQT2X = L.circle([33.633600, -111.806787], new CreateMarker("QT2X", "?", 2627, ["QT7"])).addTo(map).on("click", onMapClick);
...
var markerSR5 = L.circle([33.596408, -111.768626], new CreateMarker("SR5", "SR5", 1923, ["SR7", "STX"])).addTo(map).on("click", onMapClick);
...
var markerWW1 = L.circle([33.630119, -111.869872], new CreateMarker("WW1", "WW1", 1516, ["WWTX", "WW1X"])).addTo(map).on("click", onMapClick);
...
var markerWW11 = L.circle([33.611268, -111.855390], new CreateMarker("WW11", "Intersection", 1540, ["WW5", "QT5", "WW15"])).addTo(map).on("click", onMapClick);
...
var marker136X = L.circle([33.594952, -111.786379], new CreateMarkerTrailhead("136X", "Trailhead", 1771, ["SR15"])).addTo(map).on("click", onMapClick);
var markerBTX = L.circle([33.640531, -111.856722], new CreateMarkerTrailhead("BTX", "Trailhead", 1690, ["LT1"])).addTo(map).on("click", onMapClick);
var markerGTX = L.circle([33.649484, -111.858415], new CreateMarkerTrailhead("GTX", "Trailhead", 1720, ["DP11", "G02X", "G01X"])).addTo(map).on("click", onMapClick);
...
var markerQT1X = L.circle([33.627011, -111.857127], new CreateMarkerTrailhead("QT1X", "Trailhead", 1584, ["QT1"])).addTo(map).on("click", onMapClick);
var markerRTX = L.circle([33.598084, -111.804753], new CreateMarkerTrailhead("RTX", "Trailhead", 1739, ["RT1"])).addTo(map).on("click", onMapClick);
...
var markerWWTX = L.circle([33.630502, -111.870109], new CreateMarkerTrailhead("WWTX", "Trailhead", 1530, ["WW1"])).addTo(map).on("click", onMapClick);
