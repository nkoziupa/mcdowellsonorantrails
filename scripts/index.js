...
var markerXF08 = L.circle([33.623125, -111.778754], new CreateMarker("XF08", "Intersection", 2666, ["AK4", "XF11", "XF25"])).addTo(map).on("click", onMapClick);
var markerXF12 = L.circle([33.625178, -111.78019], new CreateMarker("XF12", "Scenic Point", 3036, ["XF11"])).addTo(map).on("click", onMapClick);
var markerXF11 = L.circle([33.625412, -111.780844], new CreateMarker("XF11", "Intersection", 3037, ["XF08", "XF13", "XF12"])).addTo(map).on("click", onMapClick);
...
var markerXF17 = L.circle([33.63456, -111.782076], new CreateMarker("XF17", "Intersection", 2474, ["XF18", "XF30", "XF34"])).addTo(map).on("click", onMapClick);
...
var markerXF19 = L.circle([33.629652, -111.778399], new CreateMarker("XF19", "Intersection", 2522, ["XF13", "XF18", "XF34"])).addTo(map).on("click", onMapClick);
...
var markerXF39 = L.circle([33.614644, -111.765800], new CreateMarker("XF39", "RT3", 2458, ["XF38", "XF40", "XF41"])).addTo(map).on("click", onMapClick);
