...
var markerXF26 = L.circle([33.634274, -111.782788], new CreateMarker("XF26", "Intersection", 2520, ["XF27", "XF28", "XF18"])).addTo(map).on("click", onMapClick);
