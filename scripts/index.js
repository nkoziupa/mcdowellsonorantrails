...
var markerFIAX = L.circle([33.748252, -111.798035], new CreateMarker("FIAX", "Intersection", 2571, ["FIBX", "FIDX", "WB8"])).addTo(map).on("click", onMapClick);
var markerFICX = L.circle([33.747222, -111.798912], new CreateMarker("FICX", "Scenic Point", 2567, ["FIBX"])).addTo(map).on("click", onMapClick);
