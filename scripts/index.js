...
var markerHW2X = L.circle([33.747095, -111.886493], new CreateMarker("HW2X", "Intersection", 2341, ["AG2X", "HW46", "PD5X", "PDTX"])).addTo(map).on("click", onMapClick);
...
var markerLG25 = L.circle([33.754321, -111.875620], new CreateMarker("LG25", "LG25", 2447, ["LG28", "LG24", "SW1X"])).addTo(map).on("click", onMapClick);
...
var markerLG28 = L.circle([33.750307, -111.879637], new CreateMarker("LG28", "LG28", 2400, ["LG29", "LG25", "SW2X"])).addTo(map).on("click", onMapClick);
...
var markerPD1X = L.circle([33.746212, -111.887555], new CreateMarker("PD1X", "Access Point", 2330, ["PD2X"])).addTo(map).on("click", onMapClick);
var markerPD3X = L.circle([33.746685, -111.887609], new CreateMarker("PD3X", "Intersection", 2330, ["PDHX", "PD4X", "PD2X"])).addTo(map).on("click", onMapClick);
var markerPD2X = L.circle([33.746471, -111.887330], new CreateMarker("PD2X", "Intersection", 2331, ["PD1X", "PD3X", "PDTX"])).addTo(map).on("click", onMapClick);
var markerPD4X = L.circle([33.747220, -111.887308], new CreateMarker("PD4X", "Intersection", 2337, ["PD3X", "RH1X", "AG2X"])).addTo(map).on("click", onMapClick);
var markerPD5X = L.circle([33.746698, -111.886284], new CreateMarker("PD5X", "Intersection", 2340, ["PDTX", "HW2X", "PR5X", "HV75", "PD7X"])).addTo(map).on("click", onMapClick);
...
var markerPDTX = L.circle([33.746397, -111.886909], new CreateMarkerTrailhead("PDTX", "Trailhead", 2335, ["PD2X", "AG2X", "HW2X", "PD5X", "PD7X"])).addTo(map).on("click", onMapClick);
...
$("#infocontainer-infoandactions-button").on("click", function() {
  ...
  if (infoContainer2MapOverlayShown === true && infoContainer2Visible === true) {
    ...
    routePlanArrayHTML = routePlanArrayHTML + "<span class='routeplanmarker'>" + routePlanArray[x] + "</span>" + " " + "<span class='routeplanseparator'>to</span>" + " " + "<span class='routeplanmarker'>" + routePlanArray[x + 1] + "</span>" + "<br>" + "<span class='routeplanseparator'>via</span>" + " " + "<span class='routeplansegment'>" + routePlanArray[x + 2] + "</span>" + "<br>" + "<span class='routeplanmiles'>" + routePlanArray[x + 3] + "</span>" + "<span class='routeplanelevgain'>" + routePlanArray[x + 4] + "</span>" + "<br>" + "<span class='routeplansubtotals'>Subtotals</span>" + "<br>" + "<span class='routeplansubtotalmiles'>" + routePlanMilesArray[y] + "</span>" + "<span class='routeplansubtotalelevgain'>" + routePlanElevGainArray[y] + "</span>" + "<br>" + "<br>";
    x = x + 5;
    y = y + 1;
    };
